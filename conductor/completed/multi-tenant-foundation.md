...
## Objective
Transform the M&P Support prototype from a telecom-specific application into a **multi-tenant platform** capable of serving different partners (projects) with unique branding, logic, and AI rules.
