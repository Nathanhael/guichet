  ...
  try {
    ...
    if (Array.isArray(datesToAggregate)) {
      ...
      await run(
        ...
        (date, total, closed, abandoned, reopened, "avg_response_ms", "avg_duration_ms", "avg_rating", "rating_count", "sla_resolved", "sla_compliant", "p95_response_ms", "sentiment_sum", "sentiment_count", "dept_counts", "ratings_by_dept", hourly)
        ...
        [
          date, stats.total, stats.closed, stats.abandoned, stats.reopened,
