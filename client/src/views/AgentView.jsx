        ...
        <nav className="bg-brand-900/95 backdrop-blur-md text-white px-6 py-3 flex items-center justify-between shadow-lg sticky top-0 z-50 border-b border-brand-800">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-gray-400 hover:text-white text-sm flex items-center gap-1.5 ml-2 px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
              title={t('feedback')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button onClick={logout} className="text-gray-400 hover:text-rose-400 text-sm font-medium ml-2 transition-colors">{t('sign_out')}</button>
          </div>
        </nav>
