...
const translations: Translations = {
  en: {
    ...
    online_experts: 'Online experts',
    no_experts_online: 'No experts online',
    ...
    max_chats_reached: 'You can only have up to 4 active chats at a time.',
    archive_search_placeholder: 'Search name, CDBID, Dare Ref\u2026',
    show_all: 'Show all',
    tab_view: 'Tab view',
  ...
  fr: {
    ...
    online_experts: 'Experts en ligne',
    no_experts_online: 'Aucun expert en ligne',
    ...
    max_chats_reached: 'Vous ne pouvez avoir que 4 chats actifs \u00e0 la fois.',
    archive_search_placeholder: 'Rechercher par nom, CDBID, Dare Ref\u2026',
  ...
  nl: {
    ...
    online_experts: 'Online experts',
    no_experts_online: 'Geen experts online',
    ...
    max_chats_reached: 'Je kunt maximaal 4 actieve chats tegelijk hebben.',
    archive_search_placeholder: 'Zoek op naam, CDBID, Dare Ref\u2026',
    show_all: 'Toon alles',
