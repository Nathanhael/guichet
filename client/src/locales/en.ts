const en: Record<string, string> = {
    ...
    filter_guests_b2b: 'Guest B2B',
    stale_guest_singular: 'stale guest',
    stale_guest_plural: 'stale guests',
    dormant_guest_review_tooltip: 'B2B guests inactive for 30+ days — review for removal',
    // AdminTeam — B2B invite strip
    b2b_guest_invites: 'B2B Guest invites',
    pending_invites_count: '{count} awaiting Azure tenant registration',
    no_pending_invites_hint: 'No pending invites — invite an external partner to start',
    invite_b2b_guest: 'Invite B2B guest',
    ...
    external_role_prefix: 'External {role}',
    invite_pending_pill: 'Invite pending',
    selects_per_ticket: 'Selects per ticket',
    support_requires_department: 'Support requires at least one department',
    no_departments_assigned: 'No departments assigned',
    audit_history: 'Audit history',
    audit_history_for: 'Audit history for {name}',
    remove_b2b_guest: 'Remove B2B guest',
    remove_member_aria: 'Remove {name}',
    remove_member_message: 'Remove {name} from this partner? They will lose access to all partner resources.',
    // AdminTeam — invite modal
    invite_external_user_title: 'Invite external user',
    field_label_name: 'Name',
    field_label_email: 'Email',
    placeholder_full_name: 'Full name',
    placeholder_user_email: 'user@domain.com',
    role_external_support: 'External support',
    role_partner_manager: 'Partner manager / SPOC',
    ...
    local_record_created: 'Local record created',
    azure_b2b_required: 'Azure B2B invite still required',
    azure_b2b_explanation: '{name} is registered in Guichet but cannot log in yet. A platform operator must add them as a B2B guest in the Azure tenant before they can SSO. Forward the handoff details to your IT admin.',
    handoff_details: 'Handoff details',
    handoff_name: 'Name',
    handoff_email: 'Email',
    handoff_role: 'Role',
    handoff_azure_step: 'Azure step',
    handoff_azure_step_value: 'Invite as B2B guest, map tenant groups',
    copy_handoff: 'Copy handoff',
    handoff_clipboard_text: '{name} <{email}> — needs Azure B2B guest invite for Guichet (role: {role})',
    ...
    delete: 'Delete',
    edited: 'edited',
    email_already_exists_error: 'This email is already in use.',
