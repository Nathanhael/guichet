  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8 border-b-4 border-black dark:border-white pb-6">
        ...
        <button onClick={onInviteClick} className="bg-black dark:bg-white text-white dark:text-black px-8 py-3 text-[10px] font-black uppercase tracking-widest border-2 border-black dark:border-white hover:invert shrink-0">{t('invite_new_user')}</button>
      </div>
                ...
                <tr key={u.id} className="text-sm font-bold hover:bg-black/5 dark:hover:bg-white/5">
                  ...
                  <td className="p-4 text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      })} className="text-[10px] font-black uppercase tracking-widest border border-black/20 dark:border-white/20 px-3 py-1.5 hover:border-black dark:hover:border-white opacity-40 hover:opacity-100">{t('delete_account')}</button>
                    </div>
                  </td>
                </tr>
