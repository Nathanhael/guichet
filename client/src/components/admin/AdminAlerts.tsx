  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-solarized-base01 dark:text-white flex items-center gap-2">
            <Flame className="text-rose-500 animate-pulse" size={24} />
            Topic Heat Alerts
          </h2>
          <p className="text-xs text-solarized-base1 dark:text-gray-400 mt-1">
            Intelligent incident detection based on real-time conversation clustering.
          </p>
        </div>

        <div className="flex bg-solarized-base2 dark:bg-brand-900/50 p-1 rounded-xl border border-solarized-base2 dark:border-brand-800">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-bold capitalize transition-all ${
                filter === s
                  ...
                  : 'text-solarized-base1 dark:text-gray-400 hover:text-solarized-base01 dark:hover:text-gray-200'
              }`}
            >
              {s}
            </button>
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="glass-card p-12 text-center border-dashed border-2 border-solarized-base2 dark:border-brand-800 bg-transparent">
            <div className="w-16 h-16 bg-emerald-500/10 text-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4">
              <CheckCircle2 size={32} />
            </div>
            <h3 className="text-lg font-bold text-solarized-base01 dark:text-white">System Neutral</h3>
            <p className="text-sm text-solarized-base1 dark:text-gray-400 mt-1 max-w-xs mx-auto">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2 flex-wrap">
                        ...
                        <span className="px-2 py-0.5 rounded bg-solarized-base2 dark:bg-brand-900/50 text-solarized-base1 dark:text-gray-400 text-[10px] font-black uppercase tracking-widest border border-solarized-base2 dark:border-brand-800">
                          {alert.dept}
                        </span>
                        <span className="text-xs text-solarized-base1 font-medium">
                      ...
                      <h3 className="text-lg font-black text-solarized-base01 dark:text-white tracking-tight mb-1">
                        {alert.topic}
                      </h3>
                      <p className="text-sm text-solarized-base01 dark:text-gray-300 leading-relaxed mb-4">
                        {alert.summary}
                      </p>

                      <div className="flex items-center gap-4 text-xs">
                        <div className="flex items-center gap-1.5 text-solarized-base1 dark:text-gray-400">
                    ...
                    <div className="flex flex-col gap-2 shrink-0">
                      ...
                      {alert.status === 'resolved' && (
                        <div className="text-right px-2">
                          ...
                          <p className="text-xs font-bold text-solarized-base1">
