...
interface ArchiveDrawerProps {
    preview: ArchiveTicket | null;
    messages: Message[];
    allLabels: Label[];
    onClose: () => void;
    duration: (t: ArchiveTicket) => string;
    DEPT_COLOR: Record<string, string>;
}

export default function ArchiveDrawer({ preview, messages, allLabels, onClose, duration, DEPT_COLOR }: ArchiveDrawerProps) {
