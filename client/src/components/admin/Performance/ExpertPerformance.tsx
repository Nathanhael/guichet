...
import { ExpertPerformanceTrend } from '../../../types';

interface ExpertPerformanceProps {
    expertStats: ExpertPerformanceTrend[];
    className?: string;
}

export default function ExpertPerformance({ expertStats, className = '' }: ExpertPerformanceProps) {
