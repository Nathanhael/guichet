...
interface AgentActivityTrendProps {
    agentStats: ExpertPerformanceTrend[];
    className?: string;
}

export default function AgentActivityTrend({ agentStats, className = '' }: AgentActivityTrendProps) {
